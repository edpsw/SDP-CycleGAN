...
class Generator(object):
    def __init__(self, width = 41, height= 1, channels = 1):
        self.W = width
        self.H = height
        self.C = channels
...
#        self.Generator.compile(loss='binary_crossentropy', optimizer=self.OPTIMIZER)
    ...
    def model(self):
        ...
        down_1 = Convolution2D(32  , kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(input_layer)

        down_2 = Convolution2D(32*2, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(down_1)
        norm_2 = BatchNormalization()(down_2)

        down_3 = Convolution2D(32*4, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(norm_2)
        norm_3 = BatchNormalization()(down_3)

#        down_4 = Convolution2D(64*8, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(norm_3)
#        norm_4 = BatchNormalization()(down_4)
#
#        down_5 = Convolution2D(64*8, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(norm_4)
#        norm_5 = BatchNormalization()(down_5)
#
#        down_6 = Convolution2D(64*8, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(norm_5)
#        norm_6 = BatchNormalization()(down_6)
#
#        down_7 = Convolution2D(64*8, kernel_size=4, strides=1, padding='same',activation=LeakyReLU(alpha=0.2))(norm_6)
#        norm_7 = BatchNormalization()(down_7)


        upsample_1 = UpSampling2D(size=1)(norm_3)
        up_conv_1 = Convolution2D(32*8, kernel_size=4, strides=1, padding='same',activation='relu')(upsample_1)
        norm_up_1 = BatchNormalization(momentum=0.8)(up_conv_1)
        add_skip_1 = Concatenate()([norm_up_1,norm_2])


#        upsample_2 = UpSampling2D(size=1)(add_skip_1)
...
#        upsample_3 = UpSampling2D(size=1)(add_skip_2)
...
#
#
#        upsample_4 = UpSampling2D(size=1)(add_skip_3)
...
#
#        upsample_5 = UpSampling2D(size=1)(add_skip_4)
...
#
#        upsample_6 = UpSampling2D(size=1)(add_skip_5)
...
#        add_skip_6 = Concatenate()([norm_up_6,down_1])
        ...
        last_upsample = UpSampling2D(size=1)(add_skip_1)
...
# =============================================================================
    ...
    def save_model(self):
        plot_model(self.Generator, to_file='./output/Generator_Model.png')
